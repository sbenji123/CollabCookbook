    ...
    recipeList: [
        {id: '1', title: "Date Balls", author: "Samuel Benjamin", prepTime: "20 minutes", totalTime: "60 minutes", servingSize: 6,
            ...
            directions: ["Put the first 3 ingredients in a large skillet and stir on low until it becomes steamy hot, but not boiling.",
                        ...
                        "Cool mixture slightly.  Roll small balls of the mixture in coconut.  Place them on wax paper to cool.  Place in refrigerator or freezer until serving."],
            image: '/img/food.jpg'},
        {id: '2', title: "Date Ball-2", author: "Samuel Benjamin", prepTime: "20 minutes", totalTime: "60 minutes", servingSize: 6,
            ingredients: ["1 stick of butter",
                        "1 cup of brown sugar",
                        "8 oz. chopped dates",
                        "1 egg, beaten",
            ...
            directions: ["Put the first 3 ingredients in a large skillet and stir on low until it becomes steamy hot, but not boiling.",
                        ...
                        "Cool mixture slightly.  Roll small balls of the mixture in coconut.  Place them on wax paper to cool.  Place in refrigerator or freezer until serving."],
            image: '/img/food.jpg'},
        {id: '3', title: "Date Balls-3", author: "Samuel Benjamin", prepTime: "20 minutes", totalTime: "60 minutes", servingSize: 6,
            ingredients: ["1 stick of butter",
                        "1 cup of brown sugar",
                        "8 oz. chopped dates",
                        "1 egg, beaten",
...
const recipeReducer = (state = initState, action) => {
    switch (action.type) {
        case 'NAV_TO_RECIPE': {
            ...
            const recipeListWithoutEdited = state.recipeList.filter(recipe => recipe.id !== action.recipe.id)
            state.recipe = action.recipe
            state.recipeList = [...recipeListWithoutEdited, action.recipe]
            break
        } case 'REMOVE_RECIPE': {
            console.log('Recipe Removed', action.recipe)
            state.recipeList = [...state.recipeList.filter(recipe => recipe.id !== action.recipe.id)]
            break
        } case 'DELETE_RECIPE': {
